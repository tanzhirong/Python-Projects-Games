...
class Ship:
    ...
    def shoot(self):
        ...
        mil_pos=[self.pos[0] + self.radius*direction[0], self.pos[1] + self.radius*direction[1]]
        mil_vel=[self.vel[0]+direction[0]*5,self.vel[1]+direction[1]*5]  
        a_missile = Sprite(mil_pos, mil_vel, 0, 0, 
...
def draw(canvas):
    ...
    canvas.draw_image(debris_image, center, size, 
                      (wtime + WIDTH / 2, HEIGHT / 2), (WIDTH, HEIGHT))
    canvas.draw_text("Lives: " + str(lives), (50, 40), 24, "Yellow")
    canvas.draw_text("Score: " + str(score), (650, 40), 24, "Yellow")
...
def rock_spawner():
    ...
    a_rock = Sprite([random.randrange(0, WIDTH), random.randrange(0, HEIGHT)],
                    ...
                    random.random()*2*math.pi, random.random()*0.12,
